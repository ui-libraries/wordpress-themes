...
<html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
	<head>
		...
		<link href="https://fonts.googleapis.com/css?family=EB+Garamond|Josefin+Sans" rel="stylesheet">
		<link href="https://fonts.googleapis.com/css?family=Libre+Baskerville" rel="stylesheet">
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>

		<link rel="stylesheet" href='<?php echo get_stylesheet_directory_uri(); ?>/timeline/timeline.css' type="text/css" media="all">

		<script type='text/javascript' src='<?php echo get_stylesheet_directory_uri(); ?>/timeline/main.js'></script>
		<script type='text/javascript' src='<?php echo get_stylesheet_directory_uri(); ?>/timeline/modernizr.js'></script>
