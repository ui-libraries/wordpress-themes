...
<head>
	...
	<meta name="description" content="In the spring and summer of 2018, a series of large-scale worksite raids struck immigrant and mixed-status communities throughout the rural heartland of the United States. These raids, which targeted immigrant workers in rural agricultural, food processing and manufacturing worksites in six different communities, resulted in over 600 arrests. This project brings together interviews from people living in these communities, focus groups with student researchers who conducted and coded the interviews, and art from young artists to provide a fuller picture of enduring and traumatic impacts of large-scale immigration worksite raids in rural America.">
	...
	<!--Site Specific - Google tag (gtag.js) --> <script async src="https://www.googletagmanager.com/gtag/js?id=G-8SXDE12DJM"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-8SXDE12DJM'); </script>
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="header-content">
			<div class="header-main">
				<div class="site-title col-xs-9 col-sm-9 col-md-6">
					<?php
					if ( ! empty ( $logo ) ) {?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo $logo; ?>"></a>
						<?php
					} else { ?>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="site-title"><img id="icon-image" src="https://dsps.lib.uiowa.edu/iceintheheartland/wp-content/uploads/sites/80/2021/04/ICE_LogoIconOnly.png" width="25" alt="Logo of water tower with butterfly logo"><?php bloginfo( 'name' ); ?></a>
						<?php
				...
				<div class="main-header-right-side col-xs-9 col-sm-5 col-md-6">
					...
					<nav id="primary-navigation" class="col-xs-6 col-sm-10 col-md-8 site-navigation primary-navigation navbar-collapse collapse" role="navigation">
						<?php
							wp_nav_menu(
								array(
				...
				<div class="reading-header-right-side col-xs-9 col-sm-9 col-md-8">
